...
object PermissionUtils {
    ...
    fun logPermissionStatus(context: Context, tag: String = "PermissionUtils") {
        ...
        android.util.Log.d(tag, "Permission Status:")
        android.util.Log.d(tag, "  Bluetooth:")
        android.util.Log.d(tag, "    ├─ SCAN: ${hasBluetoothScanPermission(context)}")
        android.util.Log.d(tag, "    ├─ CONNECT: ${hasBluetoothConnectPermission(context)}")
        android.util.Log.d(tag, "    └─ LOCATION: ${hasLocationPermission(context)}")
        android.util.Log.d(tag, "  Storage:")
        android.util.Log.d(tag, "    └─ ${hasStoragePermission(context)}")
        android.util.Log.d(tag, "  Notification:")
        android.util.Log.d(tag, "    └─ ${hasNotificationPermission(context)}")
        android.util.Log.d(tag, "  All Required: ${hasAllRequiredPermissions(context)}")
        android.util.Log.d(tag, "═══════════════════════════════════════")
    }
}